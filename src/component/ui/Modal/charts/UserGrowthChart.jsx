...
import { injectChartStyles } from "./ChartStyle";
import { userDemoData } from "./DemoData";
...
export default function UserGrowthChart() {
  ...
  const chartData = useMemo(() => {
    const yearData = userDemoData[year] || [];
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            titleColor: "#374151",
            bodyColor: "#6b7280",
            callbacks: { label: (ctx) => ` ${ctx.parsed.y} users` },
          },
        },
        scales: {
          x: {
  ...
  return (
    <div className="growth-chart-card">
      <div className="growth-chart-header">
        <span className="growth-chart-title">User Growth</span>
        <select
