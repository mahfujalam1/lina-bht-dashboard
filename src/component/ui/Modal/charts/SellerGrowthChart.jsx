...
import { sellerDemoData } from "./DemoData";
...
export default function SellerGrowthChart() {
  ...
  const chartData = useMemo(() => {
    const yearData = sellerDemoData[year] || [];
      ...
      options: {
        ...
        plugins: {
          ...
          tooltip: {
            ...
            titleColor: "#374151",
            bodyColor: "#6b7280",
            callbacks: { label: (ctx) => ` ${ctx.parsed.y} sellers` },
          },
        },
        scales: {
          x: {
  ...
  return (
    <div className="growth-chart-card">
      <div className="growth-chart-header">
        <span className="growth-chart-title">Seller Growth</span>
        <select
